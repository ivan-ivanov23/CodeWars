...
function although you will need to account for adding trailing zeros if they are missing (though you won't have to worry about a 
dangling period).
...
# Test
print(format_money(3))  # Expected: $3.00
print(format_money(3.1))  # Expected: $3.10
